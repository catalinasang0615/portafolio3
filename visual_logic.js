...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getElements, MediaHTML5, bindListener, getMaterialEditableTextures,
...
registerOnClick('boton1', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook1', '1', 4, function() {}, 0);
}, function(event) {});

registerOnClick('boton9', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook9', '9', 4, function() {}, 0);
}, function(event) {});

registerOnClick('boton2', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook2', '2', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton3', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook3', '3', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton10', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook10', '10', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton11', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook11', '11', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton4', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook4', '4', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton12', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook12', 'Plane.002', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton5', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook5', 'Plane.001', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton13', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook13', '13', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton6', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook6', '6', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton14', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook14', '14', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton7', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook7', '7', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton15', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook15', '15', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton8', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook8', '8', 5, function() {}, 0);
}, function(event) {});

registerOnClick('boton16', false, false, [0,1,2], false, function(event) {
    tweenCamera('camlook16', '16', 5, function() {}, 0);
}, function(event) {});

registerOnHover('Plane.002', false, function(event) {
    setHTMLElemStyle('cursor', 'pointer', ['BODY'], false);
}, function(event) {
    setHTMLElemStyle('cursor', 'default', ['BODY'], false);
});
click = 'ON';
videoCelular = loadVideo('https://raw.githack.com/catalinasang0615/video6/main/WhatsApp%20Video%202025-12-09%20at%2010.18.12%20PM.mp4');
registerOnClick('Plane.002', false, false, [0,1,2], false, function(event) {
    if (click == 'ON') {
        replaceTexture('Material.004', 'pantalla.jpg.001', videoCelular, false, function() {
            playSound(videoCelular, true);
            click = 'OFF';
        });
    } else {
        replaceTexture('Material.004', 'pantalla.jpg.001', videoCelular, false, function() {
            pauseSound(videoCelular);
            click = 'ON';
        });
    }
}, function(event) {});
